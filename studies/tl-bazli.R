...
euro.d$value <- euro.d$value * data$value
euro.c <- euro.d$value
...
brent.d$value <- brent.d$value * data$value
...
gold.d$value <- gold.d$value * data$value
gold.c <- gold.d$value
...
dataset.sum <-  t(format(dataset.sum, digits = 6))
